...
const ResponsiveBanner = ({image,tag,title,description,link,reverse}) => {
  return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0">
                ...
                <div className='flex flex-col justify-center text-center md:text-left space-y-4 lg:max-w-[500px]' >
                    ...
                    <motion.p
                       ...
                       initial='hidden'
                       whileInView={'visible'} className='text-xl lg:text-2xl font-semibold capitalize '>{title}</motion.p>
                    <motion.p
                       variants={SlideUp(0.9)}
                       initial='hidden'
                       whileInView={'visible'} className='text-sm text-slate-500 '>{description}</motion.p>
                    <motion.div 
